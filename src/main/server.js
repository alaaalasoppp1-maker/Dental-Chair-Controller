...
class ChairServer {
  ...
  async start() {
    ...
    this.wss.on("connection",socket=>{
      ...
      this.logDiagnostic("success","display_connected",{remote:remoteAddress,selectedIp:this.selectReachableIp(remoteAddress)});
      ...
      socket.send(JSON.stringify({type:"hello",protocol:3,controllerVersion:"2.9.4",sessionId:this.sessionId,...this.getHelloPayload()}));
