...
class ChairServer {
  ...
  async start() {
    ...
    this.wss.on("connection",socket=>{
      ...
      socket.send(JSON.stringify({type:"hello",protocol:3,controllerVersion:"2.9.6",sessionId:this.sessionId,...this.getHelloPayload()}));
